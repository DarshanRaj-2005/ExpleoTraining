...
```ts
  ...
  8  |     await page.locator('#sum1').pressSequentially('20',{delay:100})
  9  |     await page.locator("#sum1").fill('20')
  10 |     await expect(page.locator("#sum1")).toHaveValue('20')
  11 |     await page.locator("#sum2").fill('20')
  12 |     await expect(page.locator("#sum2")).toHaveValue('20')
  13 |     await page.locator("//form[@id='gettotal']/button").hover()
  14 |     await page.locator("//form[@id='gettotal']/button").dblclick()
  15 |     let expected = "40"
> 16 |     await expect(page.locator("//p[@id='addmessage']")).toHaveText("40")
     |                                                         ^ Error: expect(locator).toHaveText(expected) failed
  17 |     await expect(await page.locator("//p[@id='addmessage']").textContent()).toContain(expected)
  18 | })
```