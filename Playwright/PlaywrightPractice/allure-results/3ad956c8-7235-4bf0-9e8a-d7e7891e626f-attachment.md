...
```ts
  ...
  14 |     let value = await page.locator("//input[@id='user-message']").inputValue()
  15 |     console.log(value)
> 16 |     await expect(page.locator("//input[@id='user-message']")).toHaveText("Darshan")
     |                                                               ^ Error: expect(locator).toHaveText(expected) failed
  17 |     //await page.getByRole('button',{name:'Get Checked Value'}).dblclick()
  18 | 
  19 |     // await expect(page.locator("#message")).toHaveText("Darshan")
  20 |     // let mes2 = await page.locator('mes2').textContent()
  21 |     // console.log("The New Message:",mes2)
  22 | })
```