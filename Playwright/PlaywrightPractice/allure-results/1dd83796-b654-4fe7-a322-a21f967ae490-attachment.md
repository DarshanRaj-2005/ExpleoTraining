...
Call log:
  - waiting for locator('iframe[src=\'/innerframe\']').contentFrame().locator('//*[@id=\'root\']/div/div/div/input')
              ...
              - generic [active] [ref=f1e1]:
                - generic [ref=f1e4]:
                  ...
                  - generic [ref=f1e6]:
                    ...
                    - generic [ref=f1e10]:
                      ...
                      - textbox "Enter email" [ref=f1e12]: raj
                    ...
                    - generic [active] [ref=f5e1]:
                      ...
                      - insertion [ref=f5e9]:
                        - generic [ref=f5e12]:
                          ...
                          - link "Development Tools" [ref=f5e15] [cursor=pointer]:
                            - generic "Development Tools" [ref=f5e16]
                            - img [ref=f5e18]
                ...
                - insertion [ref=f1e18]:
                  - generic [ref=f1e21]:
                    ...
                    - link "Target Locator Training" [ref=f1e24] [cursor=pointer]:
                      - generic "Target Locator Training" [ref=f1e25]
                      - img [ref=f1e27]
                    - link "Test Automation Tools" [ref=f1e29] [cursor=pointer]:
                      - generic "Test Automation Tools" [ref=f1e30]
                      - img [ref=f1e32]
                    - link "Web Browsers" [ref=f1e34] [cursor=pointer]:
                      - generic "Web Browsers" [ref=f1e35]
                      - img [ref=f1e37]
          - generic [ref=e53]:
            - generic [ref=e54]:
              - img [ref=e55]
  ...
  - insertion [ref=e116]:
    - generic [ref=e119]:
      ...
      - link "Automation Strategy Consulting" [ref=e122] [cursor=pointer]:
        ...
        - img [ref=e125]
      - link "Automation Engineer Training" [ref=e127] [cursor=pointer]:
        - generic "Automation Engineer Training" [ref=e128]
        - img [ref=e130]
      ...
      - generic [ref=f9e3]:
        ...
        - generic [ref=f9e7]:
          - generic [ref=f9e9]:
            ...
            - button "Replay" [ref=f9e31]:
              - img [ref=f9e33] [cursor=pointer]
            - img [ref=f9e38]
          - button "Learn more" [ref=f9e45] [cursor=pointer]
  - generic [ref=e141]:
...
```ts
  ...
  17 | 
  18 |     let innerframe = page.frameLocator("iframe[src='/innerframe']")
