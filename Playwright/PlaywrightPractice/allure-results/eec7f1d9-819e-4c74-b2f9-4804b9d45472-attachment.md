...
- Name: DemBlzLoginUsingJson.test.ts >> Valid Login
...
> 7  |         await page.locator("#login2").click({timeout:5000})
     |                                       ^ TimeoutError: locator.click: Timeout 5000ms exceeded.
  ...
  15 |         })
  16 |         await page.locator("//button[text()='Log in']").click({timeout:5000})
  17 | 
