...
- Name: MouseAndKeyboardActions.test.ts >> Keyboard Type
- Location: tests\MouseAndKeyboardActions.test.ts:38:5
...
Call log:
  ...
  - waiting for locator('#ta1')
    14 × locator resolved to <textarea id="ta1" rows="10" cols="80" contenteditable="true">↵</textarea>
       - unexpected value "
Hello Playwright"
