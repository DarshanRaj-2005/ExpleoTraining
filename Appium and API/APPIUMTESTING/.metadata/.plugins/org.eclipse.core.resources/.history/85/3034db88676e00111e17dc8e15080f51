...
public class YoutubeActions {
	...
	public void playVideo() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.id("com.google.android.youtube:id/search_edit_text"))).click();
		driver.findElement(By.id("com.google.android.youtube:id/search_edit_text")).sendKeys("Appium Videos");
		driver.findElements(By.id("com.google.android.youtube:id/video_title")).get(0).click();
